...
class AnnotationSpecification:
    def __init__(self, passages, out_dir, lang, udpipe=None, stanfordnlp=None, conllu=None, join=None):
        if out_dir:
...
def read_specs(args, converters=None):
    specs = [(pattern, args.out_dir, args.lang, args.udpipe, args.stanfordnlp, args.conllu, args.join)
...
def add_specs_args(p):
    ...
    group.add_argument("-s", "--stanfordnlp", help="use specified StanfordNLP model for syntactic annotation")
